use crate::{
    crystal::{self, util, BlockMap, PlaneScene, Scene},
    math::prelude::*,
};
use amethyst::{
    core::{
...
#[derive(SystemDesc)]
#[system_desc(name(ApplyRendyLightsSystemSystemDirectDesc))]
pub struct ApplyRendyLightsSystemDirect;
impl<'a> System<'a> for ApplyRendyLightsSystemDirect {
    type SystemData = (
        Entities<'a>,
        WriteExpect<'a, Arc<Scene>>,
        ReadExpect<'a, Arc<PlaneScene>>,
